...
const Add = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("http://localhost:3000/api/add_entries", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-4">Add New Word</h1>
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          <label htmlFor="example" className="block text-lg font-semibold mb-1">
            Example:
          </label>
          <textarea
            id="example"
